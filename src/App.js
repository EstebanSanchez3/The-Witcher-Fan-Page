...
function App() {
  return (
    <div>
      ...
      {/*--------------ARMOR------------------*/}
      <div>
        <div className="content-armor">
          <div>
          <h1 className="title-section-armor">Partes de Armadura</h1>
            <div className="carousel-armor">
              <Armors
          ...
          <div>
          <h1 className="title-section-armor">Más que una pieza bonita</h1>
          <div className="description-text-armor">Hay varios tipos de armaduras, desde las más simples a las más sofisticadas, las armaduras se dividen en <b> coraza,
            guantes, pantalones y botas.</b> Dentro de la variedad de las armaduras, existen los sets, combinaciones de piezas las cuales al juntar, dotan al
            portador con bonificaciones únicas, estos sets son pertenecientes a las diferentes escuelas de brujo. Para encontrar estos codiciados sets,
            es necesario encontrar los diferentes diagramas, los cuales, están esparcidos por el continente, estos diagramas también esconden la formula
            para crear las diferentes espadas de cada escuela. 
            </div>
          </div>
        </div>
      </div>
